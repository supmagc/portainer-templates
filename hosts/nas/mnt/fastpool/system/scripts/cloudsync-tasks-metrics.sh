...
#   Command:  /mnt/fastpool/system/scripts/cron-wrapper.sh cloudsync-tasks 1800 -- /mnt/fastpool/system/scripts/cloudsync-tasks-metrics.sh
...
print("# HELP scheduled_job_last_exit_code See cron-wrapper.sh - shared scheduled-job metric family. 0 = last run SUCCESS, 1 = otherwise.")
